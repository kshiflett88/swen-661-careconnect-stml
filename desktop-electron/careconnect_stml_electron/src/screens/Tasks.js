...
function Tasks(props) {
    return (<main style={{ maxWidth: 900, margin: "0 auto", padding: 24 }}>
      ...
      <section style={{ background: "#fff", borderRadius: 12, padding: 20, border: "1px solid #DDD" }}>
        ...
        <button onClick={props.onBack} style={{ marginTop: 14, fontSize: 18, padding: "12px 16px", borderRadius: 10, border: "2px solid #37474F", background: "#fff", cursor: "pointer" }} aria-label="Return to dashboard">
          Return to Home
        </button>
      </section>
    </main>);
